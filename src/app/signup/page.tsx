...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-white">
      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-purple-600 to-indigo-700 text-white p-12 flex-col justify-between">
        <div>
        ...
        <div className="flex items-center justify-center h-full">
          <div className="w-full max-w-md">
            <svg viewBox="0 0 800 800" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto opacity-90">
              ...
              <g fill="white">
                <rect x="300" y="300" width="60" height="200" rx="10" />
                <rect x="380" y="260" width="60" height="240" rx="10" />
                <rect x="460" y="220" width="60" height="280" rx="10" />
                <circle cx="250" cy="180" r="40" opacity="0.4" />
                <circle cx="550" cy="540" r="50" opacity="0.4" />
                <circle cx="650" cy="380" r="30" opacity="0.3" />
              </g>
            </svg>
          </div>
        </div>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center mt-8">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/signin" className="font-medium text-indigo-600 hover:text-indigo-500 transition">
                Sign in
              </Link>
            </p>
          </div>
